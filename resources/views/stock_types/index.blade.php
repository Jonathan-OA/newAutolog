                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row buttons_grid">
                                <a class="btn btn-success"  href="{!! route('stockTypes.create') !!}">@lang('buttons.add')</a>
                            </div>
...
<script>
    ...
    $(function() {
        ...
        table = $("#stockTypes-table").DataTable({
            scrollX: true,
            scrollY: "47vh",
            ajax: 'stockTypes/datatable',
            autoWidth: true,
            fixedColumns:   {
                leftColumns: 0,
                rightColumns: 1
      ...
      $('#stockTypes-table tbody').on( 'click', 'button', function () {
            var data = table.row( $(this).parents('tr') ).data();
            var id = $(this).attr('id');
            if(id == 'edit'){
                //Editar Registro
                window.location.href = "{!! URL::to('stockTypes/"+data.id+"/edit') !!}";
            }else{
                //Excluir Registro
