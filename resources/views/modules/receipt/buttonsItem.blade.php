<script type="text/ng-template" id="tplButtons">     
    ...
    <div ng-attr-id="buttons{%row.id%}"  style="overflow: visible !important;" >
        ...
        <span ng-if="row.document_status_id == 0">
             ...
             <button ng-click="callRoute('../../receipt/'+row.document_id+'/items/'+row.id+'/edit')" class="icon_action" aria-label="@lang('buttons.edit')" data-microtip-position="left" role="tooltip">
