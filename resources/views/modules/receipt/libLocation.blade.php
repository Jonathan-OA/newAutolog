        ...
        <div class="col-md-12 pad-ct">
            <div class="panel panel-default" >
                ...
                <div class="panel-body" >
                    <div class="row">
                        <div class="col-md-12">
                            {!! Form::open(['url' => 'receipt/'.$document->id.'/liberate']) !!}
                            <div class="form-group">
                                <!-- Location Field -->
                                {!! Form::label('location_code', Lang::get('models.dest_location_code').':') !!}
                                {!! Form::text('location_code', null, ['class' => 'form-control', 'required', 'id' => 'autocomplete', 'table' => 'locations', 'filters' => 'SECTOR_CODE:REC']) !!}
                            </div>
