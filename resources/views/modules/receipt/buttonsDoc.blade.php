    ...
    <div ng-attr-id="buttons{%row.id%}"  style="overflow: visible !important;" >
        ...
        <span ng-if="row.document_status_id == 0">
            ...
            <span ng-if="row.lib_location == 1">
                <button ng-click="callRoute('./receipt/'+row.id+'/liberate')" class="icon_action" aria-label="@lang('buttons.liberate')" data-microtip-position="left" role="tooltip">
            ...
            <span ng-if="row.lib_location == 0">
                <button ng-click="callRoute('./document/liberate/rec', 1, 'post')" class="icon_action" aria-label="@lang('buttons.liberate')" data-microtip-position="left" role="tooltip">
                    <img class='icon' src='{{ asset('/icons/liberar.png') }}'> 
                </button>
            </span>
            ...
            <button ng-click="callRouteConfirm('./document/cancel/rec', 1,'@lang('buttons.msg_cancel')','post')" class="icon_action" aria-label="@lang('buttons.cancel')" data-microtip-position="left" role="tooltip">
        ...
        <button ng-if="row.document_status_id == 1 || row.document_status_id == 2 "
                ng-click="callRouteConfirm('./document/return/rec', 1, '@lang('buttons.msg_return')', 'post')"
