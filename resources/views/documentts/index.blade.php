                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row buttons_grid">
                                <a class="btn btn-success"  href="{!! route('documentts.create') !!}">@lang('buttons.add')</a>
                            </div>
                            <div class="panel-body">
                                @include('documentts.table')
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(function() {
        ...
        table = $("#documentts-table").DataTable({
            scrollX: true,
            scrollY: "47vh",
            ajax: 'documentts/datatable',
            autoWidth: true,
            fixedColumns:   {
                leftColumns: 0,
                rightColumns: 1
      ...
      $('#documentts-table tbody').on( 'click', 'button', function () {
            var data = table.row( $(this).parents('tr') ).data();
            var id = $(this).attr('id');
            if(id == 'edit'){
                //Editar Registro
                window.location.href = "{!! URL::to('documentts/"+data.id+"/edit') !!}";
            }else{
                //Excluir Registro
