            ...
            <div class="panel panel-default" >
                <div class="panel-heading ptabs">
                    ...
                    <ul class="nav nav-tabs">
                         ...
                         <li class="active-l"><a href="#">@lang('models.departments')</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row buttons_grid">
                            <a class="btn btn-success"  href="{!! route('departments.create') !!}">@lang('buttons.add')</a>
                            <!-- Visualizar Logs  -->
                            <a class="icon_logs" href="{!! url('logs/departments_') !!}" aria-label="@lang('buttons.logs')" data-microtip-position="left" role="tooltip">
                                <img class='icon' src='{{asset('/icons/logs.png') }}'>
                            </a>
                        </div>
                        <div class="panel-body">
                            @include('locations.departments.table')
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(function() {
      ...
      $('#departments-table tbody').on( 'click', 'button', function () {
            var data = table.row( $(this).parents('tr') ).data();
            var id = $(this).attr('id');
            if(id == 'edit'){
                //Editar Registro
                window.location.href = "{!! URL::to('departments/"+data.id+"/edit') !!}";
            }else{
                //Excluir Registro
