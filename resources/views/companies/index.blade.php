                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row buttons_grid">
                                <a class="btn btn-success"  href="{!! route('companies.create') !!}">@lang('buttons.add')</a>
                            </div>
...
<script>
    ...
    $(function() {
      ...
      $('#companies-table tbody').on( 'click', 'button', function () {
            var data = table.row( $(this).parents('tr') ).data();
            var id = $(this).attr('id');
            if(id == 'edit'){
                //Editar Registro
                window.location.href = "{!! URL::to('companies/"+data.id+"/edit') !!}";
            }else{
                //Excluir Registro
