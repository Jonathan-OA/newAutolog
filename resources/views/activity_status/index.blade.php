                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row buttons_grid">
                                <a class="btn btn-success"  href="{!! route('activityStatus.create') !!}">@lang('buttons.add')</a>
                            </div>
                            <div class="panel-body">
                                @include('activity_status.table')
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(function() {
        ...
        table = $("#activityStatus-table").DataTable({
            scrollX: true,
            scrollY: "47vh",
            ajax: 'activityStatus/datatable',
            autoWidth: true,
            fixedColumns:   {
                leftColumns: 0,
                rightColumns: 1
      ...
      $('#activityStatus-table tbody').on( 'click', 'button', function () {
            var data = table.row( $(this).parents('tr') ).data();
            var id = $(this).attr('id');
            if(id == 'edit'){
                //Editar Registro
                window.location.href = "{!! URL::to('activityStatus/"+data.id+"/edit') !!}";
            }else{
                //Excluir Registro
