        ...
        <div class="col-md-12 pad-ct">
            <div class="panel panel-default" >
                <div class="panel-heading">
                   ...
                   @lang('models.blocked_operations') 
                </div>
                <div class="panel panel-default">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row buttons_grid">
                                <a class="btn btn-success"  href="{!! route('blockedOperations.create') !!}">@lang('buttons.add')</a>
                            </div>
                            <div class="panel-body">
                                @include('blocked_operations.table')
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(function() {
        ...
        table = $("#blockedOperations-table").DataTable({
            scrollX: true,
            scrollY: "47vh",
            ajax: 'blockedOperations/datatable',
            autoWidth: true,
            fixedColumns:   {
                leftColumns: 0,
                rightColumns: 1
      ...
      $('#blockedOperations-table tbody').on( 'click', 'button', function () {
            var data = table.row( $(this).parents('tr') ).data();
            var id = $(this).attr('id');
            if(id == 'edit'){
                //Editar Registro
                window.location.href = "{!! URL::to('blockedOperations/"+data.id+"/edit') !!}";
            }else{
                //Excluir Registro
