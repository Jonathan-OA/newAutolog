                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row buttons_grid">
                                <a class="btn btn-success"  href="{!! route('blockedLocations.create') !!}">@lang('buttons.add')</a>
                            </div>
                            <div class="panel-body">
                                @include('blocked_locations.table')
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(function() {
        ...
        table = $("#blockedLocations-table").DataTable({
            scrollX: true,
            scrollY: "47vh",
            ajax: 'blockedLocations/datatable',
            autoWidth: true,
            fixedColumns:   {
                leftColumns: 0,
                rightColumns: 1
      ...
      $('#blockedLocations-table tbody').on( 'click', 'button', function () {
            var data = table.row( $(this).parents('tr') ).data();
            var id = $(this).attr('id');
            if(id == 'edit'){
                //Editar Registro
                window.location.href = "{!! URL::to('blockedLocations/"+data.id+"/edit') !!}";
            }else{
                //Excluir Registro
