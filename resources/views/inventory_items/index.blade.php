                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row buttons_grid">
                                <a class="btn btn-success"  href="{!! route('inventoryItems.create') !!}">@lang('buttons.add')</a>
                            </div>
                            <div class="panel-body">
                                @include('inventory_items.table')
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(function() {
        ...
        table = $("#inventoryItems-table").DataTable({
            scrollX: true,
            scrollY: "47vh",
            ajax: 'inventoryItems/datatable',
            autoWidth: true,
            fixedColumns:   {
                leftColumns: 0,
                rightColumns: 1
      ...
      $('#inventoryItems-table tbody').on( 'click', 'button', function () {
            var data = table.row( $(this).parents('tr') ).data();
            var id = $(this).attr('id');
            if(id == 'edit'){
                //Editar Registro
                window.location.href = "{!! URL::to('inventoryItems/"+data.id+"/edit') !!}";
            }else{
                //Excluir Registro
