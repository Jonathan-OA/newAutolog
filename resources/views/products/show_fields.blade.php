...
<div class="col-md-12">
    ...
    <p>{!! $product->product_type_code !!}</p>
</div>

<!-- Group Code Field -->
<div class="col-md-12">
    {!! Form::label('group_code', 'Group Code:') !!}
    <p>{!! $product->group_code !!}</p>
</div>

<!-- Subgroup Code Field -->
<div class="col-md-12">
    {!! Form::label('subgroup_code', 'Subgroup Code:') !!}
    <p>{!! $product->subgroup_code !!}</p>
</div>

<!-- Margin Div Field -->
<div class="col-md-12">
    {!! Form::label('margin_div', 'Margin Div:') !!}
    <p>{!! $product->margin_div !!}</p>
</div>
...
<!-- Phase Code Field -->
<div class="col-md-12">
    {!! Form::label('phase_code', 'Phase Code:') !!}
    <p>{!! $product->phase_code !!}</p>
</div>

<!-- Abz Code Field -->
<div class="col-md-12">
    {!! Form::label('abz_code', 'Abz Code:') !!}
    <p>{!! $product->abz_code !!}</p>
</div>

<!-- Inventory Date Field -->
<div class="col-md-12">
    {!! Form::label('inventory_date', 'Inventory Date:') !!}
    <p>{!! $product->inventory_date !!}</p>
</div>
