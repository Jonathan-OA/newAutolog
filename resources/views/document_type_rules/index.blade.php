                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row buttons_grid">
                                <a class="btn btn-success"  href="{!! route('documentTypeRules.create') !!}">@lang('buttons.add')</a>
                            </div>
...
<script>
    ...
    $(function() {
        ...
        table = $("#documentTypeRules-table").DataTable({
            scrollX: true,
            scrollY: "47vh",
            ajax: 'documentTypeRules/datatable',
            autoWidth: true,
            fixedColumns:   {
                leftColumns: 0,
                rightColumns: 1
      ...
      $('#documentTypeRules-table tbody').on( 'click', 'button', function () {
            ...
            if(id == 'edit'){
                //Editar Registro
                window.location.href = "{!! URL::to('documentTypeRules/"+data.id+"/edit') !!}";
            }else{
                //Excluir Registro
