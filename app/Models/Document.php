...
class Document extends Model
{
    ...
    public static function getDocuments($moviment_code, $qty)
    {
        $docs = Document::select(
            ...
            'documents.number',
            'document_type_code',
            DB::raw("CONCAT(customer_code,' - ',customers.trading_name) as customer"),
            DB::raw("CONCAT(supplier_code,' - ',suppliers.trading_name) as supplier"),
            DB::raw("CONCAT(courier_code,' - ',couriers.trading_name) as courier"),
            'vehicle_id',
            'driver_id',
            'documents.invoice',
            ...
            'documents.billing_date',
            'document_types.lib_location',
            'document_types.print_labels',
            'document_types.label_type_code',
            'document_types.print_labels_doc',
            'documents.location_code',
            'documents.number_origin',
    ...
    public static function getInfosForPrint($document_id)
    {
        ...
        $infos = Document::select(
            'documents.id as documents.id',
            'documents.company_id as documents.company_id',
            'documents.number as documents.number',
            'document_type_code as documents.document_type_code',
            'documents.invoice as documents.invoice',
            'documents.serial_number as documents.serial_number',
            'emission_date as documents.emission_date',
            'start_date as documents.start_date',
            'end_date as documents.end_date',
            'wave as documents.wave',
            'total_volumes as documents.total_volumes',
            'total_weight as documents.total_weight',
            'documents.document_status_id as documents.document_status_id',
            'total_net_weigth as documents.total_net_weigth',
            'priority as documents.priority',
            'comments as documents.comments',
            'documents.obs1 as documents.obs1',
            'documents.obs2 as documents.obs2',
            'documents.obs3 as documents.obs3',
            'documents.user_id as documents.user_id',
            'document_status.description',
            'delivery_date as documents.delivery_date',

            'customer_code as documents.customer_code',
            'customers.name as customers.name',
            'customers.trading_name as customers.trading_name',
            'customers.cnpj as customers.cnpj',
            'customers.state_registration as customers.state_registration',
            'customers.address as customers.address',
            'customers.number as customers.number',
            'customers.neighbourhood as customers.neighbourhood',
            'customers.city as customers.city',
            'customers.state as customers.state',
            'customers.country as customers.country',
            'customers.state as customers.zip_code',
            'customers.phone1 as customers.phone1',
            'customers.phone2 as customers.phone2',

            'supplier_code as documents.supplier_code',
            'suppliers.name as suppliers.name',
            'suppliers.trading_name as suppliers.trading_name',
            'suppliers.cnpj as suppliers.cnpj',
            'suppliers.state_registration as suppliers.state_registration',
            'suppliers.address as suppliers.address',
            'suppliers.number as suppliers.number',
            'suppliers.neighbourhood as suppliers.neighbourhood',
            'suppliers.city as suppliers.city',
            'suppliers.state as suppliers.state',
            'suppliers.country as suppliers.country',
            'suppliers.state as suppliers.zip_code',
            'suppliers.phone1 as suppliers.phone1',
            'suppliers.phone2 as suppliers.phone2',

            'courier_code as documents.courier_code',
            'couriers.name as couriers.name',
            'couriers.trading_name as couriers.trading_name',
            'couriers.cnpj as couriers.cnpj',
            'couriers.state_registration as couriers.state_registration',
            'couriers.address as couriers.address',
            'couriers.number as couriers.number',
            'couriers.neighbourhood as couriers.neighbourhood',
            'couriers.city as couriers.city',
            'couriers.state as couriers.state',
            'couriers.country as couriers.country',
            'couriers.state as couriers.zip_code',
            'couriers.phone1 as couriers.phone1',
            'couriers.phone2 as couriers.phone2',

            'drivers.name as drivers.name',
            'drivers.license as drivers.license',
            'drivers.phone as drivers.phone',
            ...
            ->groupBy(
                ...
                'customers.city',
                'couriers.name',
                'couriers.trading_name',
                'couriers.cnpj',
                'couriers.state_registration',
                'couriers.address',
                'couriers.number',
                'couriers.neighbourhood',
                'couriers.zip_code',
                'couriers.phone1',
                'couriers.phone2',
                'couriers.country',
                ...
                'couriers.city',
                'suppliers.name',
                'suppliers.trading_name',
                'suppliers.cnpj',
                'suppliers.state_registration',
                'suppliers.address',
                'suppliers.number',
                'suppliers.neighbourhood',
                'suppliers.zip_code',
                'suppliers.phone1',
                'suppliers.phone2',
                'suppliers.country',
